...
type ProviderConfig struct {
	...
	Type         string                `json:"type" yaml:"type" mapstructure:"type" validate:"required,oneof=openai anthropic google ollama bfl moonshot elevenlabs cosyvoice qwen qwen3 deepseek zai minimax huggingface"`
